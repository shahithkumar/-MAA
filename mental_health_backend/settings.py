...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'django_pass123'),
...
VOICE_MODEL_PATH = str(BASE_DIR / "models" / "ravdess_ser_speech_model.keras")
TEXT_MODEL_PATH = str(BASE_DIR / "models" / "emo_berta_final_permanent.pth")
